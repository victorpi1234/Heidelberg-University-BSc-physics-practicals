...
void prealign_correlations_x() {
    ...
    string histName1 = "Correlations/Timepix3_0/correlationX";
    string histName2 = "Correlations/Timepix3_1/correlationX";
    string histName3 = "Correlations/Timepix3_2/correlationX";
    string histName4 = "Correlations/Timepix3_3/correlationX";
    string histName5 = "Correlations/Timepix3_4/correlationX";
    string histName6 = "Correlations/Timepix3_5/correlationX";
    string histName7 = "Correlations/Timepix3_6/correlationX";

    string histName8 = "Correlations/Timepix3_0/correlationX";
    string histName9 = "Correlations/Timepix3_1/correlationX";
    string histName10 = "Correlations/Timepix3_2/correlationX";
    string histName11 = "Correlations/Timepix3_3/correlationX";
    string histName12 = "Correlations/Timepix3_4/correlationX";
    string histName13 = "Correlations/Timepix3_5/correlationX";
    string histName14 = "Correlations/Timepix3_6/correlationX";
    ...
    c1->Divide(2,7);
        ...
        c1->cd(3);
                ...
                h2->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(5);
                ...
                h3->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(7);
                ...
                h4->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(9);
                ...
                h5->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(11);
                ...
                h6->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(13);
            ...
            h7->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(2);
            ...
            h8->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(4);
                ...
                h9->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(6);
                ...
                h10->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(8);
                ...
                h11->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(10);
                ...
                h12->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(12);
                ...
                h13->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
        ...
        c1->cd(14);
            ...
            h14->GetXaxis()->SetTitle("$x_{ref}$ [mm]");
...
c1->SaveAs("PDFs/comparison_correlations_x.pdf");
}

...
void clustering_Tot_Timepix3_macro() {
    ...
    string histName1 = "Clustering4D/Timepix3_0/clusterSeedTot";
    string histName2 = "Clustering4D/Timepix3_0/clusterTot";
    ...
    h1->SetTitle("Timepix3_0 Cluster (Seed) Tot");
    h1->GetXaxis()->SetTitle("Cluster (Seed) Tot");
    ...
    leg->AddEntry(h1,"Seed pixel");
    leg->AddEntry(h2,"Sum of all pixel Tots");
    // Draw the legend:
    leg->Draw();

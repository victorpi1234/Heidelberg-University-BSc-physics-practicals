...
void clustering_Tot_ATLAS_macro() {
    ...
    string histName1 = "Clustering4D/ATLASpix_0/clusterSeedTot";
    string histName2 = "Clustering4D/ATLASpix_0/clusterTot";
    ...
    h1->SetTitle("ATLASpix_0 Cluster (Seed) Tot");

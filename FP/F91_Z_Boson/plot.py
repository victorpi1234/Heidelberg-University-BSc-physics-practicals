...
styleHisto(h_e, ROOT.kBlue, "M_{ll} [GeV]", "Entries", filled=True)
styleHisto(h_m, ROOT.kGreen, "M_{ll} [GeV]", "Entries", filled=True)
styleHisto(h_t, ROOT.kRed, "M_{ll} [GeV]", "Entries", filled=True)

legend.AddEntry(h_e, "Z -> ee", "lep")
legend.AddEntry(h_m, "Z -> mu mu", "lep")
legend.AddEntry(h_t, "Z -> tau tau", "lep")
